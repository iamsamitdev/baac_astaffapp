                                ...
                                builder: (BuildContext context) => SimpleDialog(
                                  ...
                                  children: [
                                    ...
                                    ListTile(
                                      ...
                                      onTap: () { 
                                        Utility.getInstance().showAlertDialog(context, 'เรียบร้อย', 'บันทึกข้อมูลเวลาเข้าทำงานเรียบร้อยแล้ว','ตกลง');
                                    ...
                                    ListTile(
                                      ...
                                      onTap: () { 
                                        Utility.getInstance().showAlertDialog(context, 'เรียบร้อย', 'บันทึกข้อมูลเวลาออกงานเรียบร้อยแล้ว','ตกลง');
                                        // Navigator.pop(context);
                                      },
                                    ),
                                    Row(
